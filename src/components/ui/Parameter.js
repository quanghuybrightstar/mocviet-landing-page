      ...
      <div className="container">
        <div className="row d-md-flex items-center justify-center">
          <div className="col-lg-4">
            <div className="heading-section lg:pl-12 heading-section-white text-center md:text-left">
              <div className="lg:pl-12 lg:ml-12">
                <span className="subheading">NHỮNG</span>
                <h2 className="mb-6 !text-[28px] md:!text-[40px]">
                  SỰ THẬT
                  <br /> ẤN TƯỢNG
                </h2>
              </div>
